...
document.addEventListener('alpine:init', () => {
    Alpine.store('cart', {
        ...
        init() {
            // Inicializar el contador desde el data attribute
            const initialCount = document.body.getAttribute('data-cart-count');
            this.count = initialCount ? parseInt(initialCount) : 0;
            ...
            Livewire.hook('message.processed', (message, component) => {
                // Actualizar cuando se agregan/eliminan productos del carrito
